...
//    }
    ...
    private func configTabBar() {
        ...
        let log = self.creatNav(with: "Log", image: UIImage(systemName: "person"), and: LogViewController())
        
        let textt = UILabel()
        textt.text = "Message"
        textt.font = .systemFont(ofSize: 24)
        
        self.setViewControllers([message, status, group, call, log], animated: true)
    }
